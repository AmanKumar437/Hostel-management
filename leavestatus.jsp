...
<body>
    ...
    <body>
       <% try {
                ...
                PreparedStatement st = con.prepareStatement("select * from leaveform where name=?");
                st.setString(1,str1);
  ...
  margin-left: 350px;">                
    <center>  
        <pre>  <h2> your leave status</h2></pre>
        <pre>Name:    <%= rs.getString(1)%></pre>
                    <pre>Id:      <%= rs.getString(2)%></pre>
                    <pre>           Leave_from:     <%= rs.getString(3)%></pre>
                    <pre>     Leave_till:            <%= rs.getString(4)%></pre>
                    <pre>     Leave_status:            </pre>
                   </center></div>
    </div
                    <%
                    }
